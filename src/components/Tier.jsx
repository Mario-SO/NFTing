    ...
    return (
        <div className="grid grid-rows bg-base-200 py-10 min-h-screen">
            <div className="mx-10 mb-10 columns-md">
                ...
                <Card image="https://placeimg.com/300/300/arch" collection="Unpolite Punks" description="Crypto Punks gone wild and unpolite. They will show you a nicely pixelated middle finger" mintPage="/" />
