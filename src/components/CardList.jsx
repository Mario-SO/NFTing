    ...
    return (
        <div className="bg-base-200 min-h-screen">
            <div className="grid px-10 pt-10 lg:grid-cols-2 md:grid-cols-1 py-10">
                ...
                <Card image="/punk.png" collection="Punks" description="Crypto Punks gone wild and unpolite. They will show you a nicely pixelated middle finger." mintPage="project" />
